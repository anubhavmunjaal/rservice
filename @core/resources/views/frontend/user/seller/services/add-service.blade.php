                                ...
                                <form action="{{route('seller.add.services')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="single-dashboard-input">
                                        ...
                                        <div class="single-info-input margin-top-30 mt-5">
                                            ...
                                            <input class="form--control" name="video" id="video" type="text" value="{{old('video')}}" placeholder="{{__('youtube embed code')}}">
                                    ...
                                    <div class="single-dashboard-input">
                                        <div class="single-info-input margin-top-30 permalink_label">
                                            ...
                                            <input class="form--control service_slug" name="slug" id="slug" value="{{old('slug')}}" style="display: none" type="text">
