        ...
        <div class="container-fluid">
            <div class="dashboard-contents-wrapper">
                ...
                <div class="dashboard-right">
                    ...
                    <x-error-message/>
                    <form action="{{route('seller.edit.service.attribute.offline.to.online',$get_service->id)}}" method="post">
                        @csrf
                            ...
                            <div class="col-xl-8 margin-top-50">
                                @if($get_service->is_service_online == 1)
                                    <div class="dashboard-switch-single margin-bottom-30">
                                        <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" disabled/>  {{__('Online To Offline Service')}}
                                        <label class="switch-label" for="is_service_online"></label>
                                    </div>
                                @else
                                    <div class="dashboard-switch-single margin-bottom-30">
                                        <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked disabled/> {{__('Offline To Online Service')}}
                                        <label class="switch-label" for="is_service_online"></label>
                                    </div>
                                @endif
                    ...
                    if(total_element < max ){
                        $(".append-additional-includes").append(
                          ...
                          @if($get_service->is_service_online == 1)  <div class="single-info-input margin-top-20 @if($get_service->is_service_online == 0) is_service_online_hide @endif">\
                            ...
                            </div>@endif<span class="btn btn-danger remove-include"><i class="las la-times"></i></span>\
                                </div>'
                        );
                    }
