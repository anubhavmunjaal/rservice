...
@section('site-title')
    {{__('Seller Extra Service Template')}}
@endsection
@section('style')
    <x-media.css/>
    <x-summernote.css/>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapp d-flex justify-content-between">
                            <h4 class="header-title">{{__('Seller Extra Service Template')}}</h4>
                        ...
                        <form action="{{route('admin.seller.extra.service')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30">
                                ...
                                <div class="form-group">
                                    <label for="seller_extra_service_message">{{ __('Email Message For Seller') }}</label>
