...
<?php endif; ?>
                                                    ...
                                                    <td><?php echo e($data->email); ?>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <a href="<?php echo e(route('admin.frontend.user.email.verify.code',$data->id)); ?>" class="btn btn-primary btn-sm mb-3 mr-1 subcategory_edit_btn"><?php echo e(__('Send Code ')); ?></a>
                                                        <?php endif; ?>
                                                    </td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/zonain/public_html/@core/resources/views/backend/pages/seller-verify/verify.blade.php ENDPATH**/ ?>