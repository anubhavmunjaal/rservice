                    ...
                    <?php if(request()->is('admin-home/child-category/*')): ?> active <?php endif; ?>">
                            ...
                            <ul class="collapse">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('child-category-create')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/subcategory/new')); ?>"><a
                                            href="<?php echo e(route('admin.subcategory.new')); ?>"><?php echo e(__('Add New Child Category')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
...
<?php /**PATH /home1/zonain/public_html/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>