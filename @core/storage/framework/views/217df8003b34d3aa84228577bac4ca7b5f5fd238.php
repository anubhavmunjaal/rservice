                                ...
                                <form action="<?php echo e(route('seller.add.services')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="single-dashboard-input">
                                        ...
                                        <div class="single-info-input margin-top-30 mt-5">
                                            ...
                                            <input class="form--control" name="video" id="video" type="text" value="<?php echo e(old('video')); ?>" placeholder="<?php echo e(__('youtube embed code')); ?>">
                                    ...
                                    <div class="single-dashboard-input">
                                        <div class="single-info-input margin-top-30 permalink_label">
                                            ...
                                            <input class="form--control service_slug" name="slug" id="slug" value="<?php echo e(old('slug')); ?>" style="display: none" type="text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/zonain/public_html/@core/resources/views/frontend/user/seller/services/add-service.blade.php ENDPATH**/ ?>