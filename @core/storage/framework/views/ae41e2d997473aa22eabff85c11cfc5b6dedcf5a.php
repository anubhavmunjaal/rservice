                        ...
                        <?php if(moduleExists('Subscription') && $commissionGlobal->system_type == 'subscription' && empty(auth('web')->user()->subscribedSeller)): ?>
                            <div class="col-lg-12">
                                <div class="alert alert-warning d-flex justify-content-between"><?php echo e(__('you must have to subscribe any of our package in order to start selling your services.')); ?>
                                    ...
                                    <a href="<?php echo e(url('/price-plan')); ?>" target="_blank" class="btn btn-secondary"><?php echo e(__('view packages')); ?></a></div>
                            </div>
                        <?php endif; ?>
                                        ...
                                        <table class="custom--table">
                                            ...
                                            <?php $__currentLoopData = $last_five_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td data-label="<?php echo e(__('Location')); ?>"><?php echo e($order->email); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/zonain/public_html/@core/resources/views/frontend/user/seller/dashboard/dashboard.blade.php ENDPATH**/ ?>