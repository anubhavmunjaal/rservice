...
class PricePlan extends \App\PageBuilder\PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $apply = __('Apply');
        $connect_text = __('Connect to get order from buyer, each order will deduct 2 connect from seller account.');
...
FORM;
        ...
        foreach($subscriptions as $subscription) {
            ...
            $connect = $type == 'lifetime' ? 'No limit' : $subscription->connect;
